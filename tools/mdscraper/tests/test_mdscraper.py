...
from mdscraper import parse_ignore_file, should_ignore, scan_directory, extract_file_content
...
"""
    ...
    def test_should_ignore(self):
        ...
        self.assertTrue(should_ignore(".hidden", patterns))  # Hidden files always ignored
