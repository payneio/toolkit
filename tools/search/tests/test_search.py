...
class TestSearchFileMatching(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(os.path.join(self.test_dir, search.SEARCH_DIR, "config.bak"), 'w') as f:
    ...
    def test_filter_files(self):
        ...
        self.assertIn(os.path.normpath(os.path.join(self.test_dir, "document.pdf")), matched_files)
        self.assertIn(os.path.normpath(os.path.join(self.test_dir, "notes.md")), matched_files)
        self.assertIn(os.path.normpath(os.path.join(self.test_dir, "nested", "nested.txt")), matched_files)
        
        # Check that excluded files were not matched
        self.assertNotIn(os.path.normpath(os.path.join(self.test_dir, "draft_document.pdf")), matched_files)
        self.assertNotIn(os.path.normpath(os.path.join(self.test_dir, search.SEARCH_DIR, "config.bak")), matched_files)
